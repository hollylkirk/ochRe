...
These plots show how each of the palettes perform for different types of colour blindness (using dichromat). Palettes that perform best for colour blindness are "galah", "namatjira", "williams_pilbara", and "healthy_ _reef"  
